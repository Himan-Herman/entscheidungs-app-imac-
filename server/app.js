...
import practiceSettingsRouter from "./routes/practiceSettings.js";
import practiceIntegrationsRouter from "./routes/practiceIntegrations.js";
import practiceCalendarRouter from "./routes/practiceCalendar.js";
import practiceAnamnesisRouter from "./routes/practiceAnamnesis.js";
import practiceBookingRouter from "./routes/practiceBooking.js";
import patientAppointmentsRouter from "./routes/patientAppointments.js";
import practiceTelemedicineRouter from "./routes/practiceTelemedicine.js";
import patientTelemedicineRouter from "./routes/patientTelemedicine.js";
import telemedicineProviderRouter from "./routes/telemedicineProvider.js";
import practiceOcrJobsRouter from "./routes/practiceOcrJobs.js";
import practiceDeveloperRouter from "./routes/practiceDeveloper.js";
...
app.use("/api/patient/wearables", requireAuth, patientWearablesRouter);
...
app.use("/api/patient/exports", requireAuth, patientExportsRouter);
...
app.use("/api/patient/billing-explainer", requireAuth, patientBillingExplainerRouter);
...
app.use("/api/patient/appointments", requireAuth, patientAppointmentsRouter);
app.use("/api/practice/telemedicine", requireAuth, practiceTelemedicineRouter);
app.use("/api/patient/telemedicine", requireAuth, patientTelemedicineRouter);
app.use("/api/telemedicine", requireAuth, telemedicineProviderRouter);
app.use("/api/practice/ocr", requireAuth, practiceOcrJobsRouter);
app.use("/api/practice/developer", requireAuth, practiceDeveloperRouter);
