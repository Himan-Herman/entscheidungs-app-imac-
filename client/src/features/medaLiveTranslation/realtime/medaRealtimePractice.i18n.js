...
const practiceChromeI18n = {
  de: {
    ...
    pdfQrHint:     'Das PDF wird zeitlich begrenzt über einen sicheren Link bereitgestellt. Der QR-Code enthält keine Gesprächsinhalte.',
  ...
  en: {
    ...
    pdfQrHint:     'The PDF is made available through a secure, time-limited link. The QR code contains no conversation content.',
  ...
  fr: {
    ...
    pdfQrHint:     "Le PDF est mis à disposition via un lien sécurisé à durée limitée. Le code QR ne contient aucun contenu de conversation.",
  ...
  it: {
    ...
    pdfQrHint:     'Il PDF viene reso disponibile tramite un link sicuro a tempo limitato. Il codice QR non contiene contenuti della conversazione.',
  ...
  es: {
    ...
    pdfQrHint:     'El PDF se pone a disposición mediante un enlace seguro de tiempo limitado. El código QR no contiene contenido de la conversación.',
