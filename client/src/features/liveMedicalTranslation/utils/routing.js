...
export function buildLanguageRouting({ patientLanguage, doctorLanguage, activeSpeaker }) {
  ...
  return {
    ...
    sourceLanguage,
    targetLanguage,
    sourceLanguageName: liveTranslationLanguageLabel(sourceLanguage),
    targetLanguageName: liveTranslationLanguageLabel(targetLanguage),
    patientLanguageName: liveTranslationLanguageLabel(patientLanguage),
    doctorLanguageName: liveTranslationLanguageLabel(doctorLanguage),
  };
}
