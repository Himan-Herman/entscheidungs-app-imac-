...
const PracticeBillingPlausibilityDetailPage = lazy(() =>
  import("./features/practiceBillingPlausibility/pages/PracticeBillingPlausibilityDetailPage.jsx"),
);
...
const PracticeBookingHubPage = lazy(() =>
  import("./features/practiceBooking/pages/PracticeBookingHubPage.jsx"),
);
...
const PracticeConsentOverviewPage = lazy(() =>
  import("./features/consent/pages/PracticeConsentOverviewPage.jsx"),
);
          ...
          <Suspense fallback={<RouteFallback />}>
            <Routes>
              <Route element={<Layout />}>
                ...
                />
                <Route
                  path="/practice/consents"
                  element={
                    <ProtectedRoute>
                      <PracticeConsentOverviewPage />
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/practice/pre-visit"
                  element={
                    <ProtectedRoute>
                ...
                />
                <Route
                  path="/practice/booking"
                  element={
                    <ProtectedRoute>
                      <PracticeBookingHubPage />
                    </ProtectedRoute>
                  }
                />
                <Route
                ...
                />
                <Route
                  path="/practice/settings/billing-plausibility/:sessionId"
                  element={
                    <ProtectedRoute>
                      <PracticeBillingPlausibilityDetailPage />
                    </ProtectedRoute>
                  }
                />
                <Route
