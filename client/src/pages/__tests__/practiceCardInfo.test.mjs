...
test("only the 11 designated practice-hub cards expose an info button", () => {
  ...
  // The 3 hub cards that intentionally have NO info button.
  for (const other of ["patients", "billingPlausibility", "medaLive", ""]) {
