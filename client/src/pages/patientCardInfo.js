...
export const PATIENT_CARD_INFO = {
  ...
  hubLinkPreVisit: {
    titleId: "patient-card-info-pre-visit-title",
  ...
  hubLinkHealthProfile: {
    ...
    titleKey: "healthProfileTitle",
    paragraphKeys: ["healthProfileP1", "healthProfileP2", "healthProfileP3"],
  },
  hubLinkVaccinations: {
    titleId: "patient-card-info-vaccinations-title",
    buttonKey: "vaccinationsButton",
  ...
  hubLinkDoctors: {
    ...
    buttonKey: "doctorsButton",
    titleKey: "doctorsTitle",
    paragraphKeys: ["doctorsP1", "doctorsP2", "doctorsP3"],
  },
  hubLinkDocuments: {
    titleId: "patient-card-info-my-documents-title",
    buttonKey: "myDocumentsButton",
    titleKey: "myDocumentsTitle",
    paragraphKeys: ["myDocumentsP1", "myDocumentsP2", "myDocumentsP3"],
  },
};
