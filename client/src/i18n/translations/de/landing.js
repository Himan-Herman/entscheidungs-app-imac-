export default {
  ...
  spotlightTitle: "Neue eigene MedScoutX-Visuals statt nur Ordnerbilder",
  spotlightBody:
    "Die Hero-Grafik zeigt logisch, wie Angaben aus Patientensicht gesammelt, strukturiert und dann für die Praxis besser lesbar vorbereitet werden.",
  spotlightList: [
    "eigene SVG-Illustration direkt im Projekt",
    "ruhige Animationen statt überladener Effekte",
    "voll responsiv auch auf kleinen Displays",
  ],
  moduleMapEyebrow: "Wichtige Bereiche",
  moduleMapTitle: "Zentrale Funktionsfelder im Überblick",
  moduleMapItems: [
    "Vorbereitung",
    "Dokumente",
    "Nachrichten",
