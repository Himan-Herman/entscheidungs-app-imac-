...
export default {
  ...
  hubCard: {
    ...
    description: "Sichere Kommunikation für internationale Patient:innen",
    badge: "Kommunikation",
    ariaLabel: "Mehrsprachige Kommunikation für diese Praxis öffnen",
  },
  hub: {
    pageTitle: "Mehrsprachige Kommunikation — Praxis",
    heading: "Mehrsprachige Kommunikation",
    intro:
  ...
  invites: {
    pageTitle: "Einladungslinks — Mehrsprachige Kommunikation",
    heading: "Einladungslinks für Patient:innen",
    intro:
      "Erstellen Sie einen sicheren Link oder QR-Code, damit Patient:innen den Dolmetscher direkt in Ihrer Praxis starten können. Gesprächstexte werden nur nach ausdrücklicher Einwilligung geteilt.",
    navAria: "Navigation Einladungslinks",
    backToDashboard: "Zurück zum Dashboard",
    actionsHeading: "Neue Einladung",
    requiredLegend: "Mit * gekennzeichnet = Pflichtfeld",
    inviteTypeLabel: "Einsatzort *",
    inviteTypeHint: "Hilft Ihnen, Links später leichter zuzuordnen.",
    inviteTypeWaitingRoom: "Wartebereich",
    inviteTypeReception: "Empfang",
    inviteTypeDoctorRoom: "Sprechzimmer",
    inviteTypeRemote: "Video / Fern",
    inviteTypeOther: "Allgemein",
    inviteTypeRequired: "Bitte wählen Sie einen Einsatzort.",
    inviteTypeSelectEmpty: "Bitte wählen",
    displayNameLabel: "Bezeichnung (optional)",
    displayNameHint: "z. B. „Empfang EG“ — nur für Ihre Übersicht.",
    displayNamePlaceholder: "Interne Bezeichnung",
    ttlHoursLabel: "Gültigkeit in Stunden (optional)",
    ttlHoursHint: "Standard: 168 Stunden (7 Tage). Maximal 720 Stunden.",
    placeholderNote:
      "Patient:innen öffnen den Link auf dem Smartphone und wählen ihre Sprachen. Sie behalten die Kontrolle über Gesprächsinhalte.",
