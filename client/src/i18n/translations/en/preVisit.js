export default {
  language: {
    ...
    doctorLanguageLabel: "Language of the doctor version",
    doctorLanguageHint:
      "Choose here in which language the doctor-facing version should be prepared.",
    continue: "Continue",
  },
  qrLanding: {
  ...
  document: {
    ...
    pageLeadFlexible:
      "Review your information and choose in which language the structured doctor version should be created. Your original patient statements remain attached separately.",
    ...
    doctorLangSelectableHint:
      "You can change here in which language the doctor-facing version should be created.",
    ...
    patientIdentityPdfConsent:
      "Include these patient details in the PDF for the practice/doctor.",
    patientIdentityPdfConsentHint:
      "Identity details appear in the PDF only if you enable this option. You can still keep the fields filled in locally for later use.",
  ...
  cases: {
    ...
    backPracticeHub: "Back to My practice",
  },
  caseDetail: {
    pageTitle: "MedScoutX — Case",
    backToList: "All cases",
    backPracticeHub: "Back to My practice",
    notFound: "This case was not found or is no longer available.",
    unnamedSession: "Untitled preparation",
    loading: "Loading…",
