export default {
  ...
  proText:
    "For frequent users and power users: higher limits, extended analysis functions and prioritized responses.",
  ...
  demoText:
    "The video symbolically shows how Meda recognizes medical patterns and helps you find orientation.",
