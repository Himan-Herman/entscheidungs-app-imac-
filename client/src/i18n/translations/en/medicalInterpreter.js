...
export default {
  ...
  conversation: {
    ...
    intro:
      "Speak naturally. After a short pause, the current turn is finalized, translated, spoken aloud, and the next turn can begin.",
  ...
  pushToTalk: {
    ...
    liveHint:
      "Speak — after a short pause it detects, translates, and keeps listening automatically.",
    disabledDraft:
  ...
  liveSession: {
    ...
    statusError: "Please check microphone or connection",
    autoModeBadge: "Auto",
    ...
    turnStatusTranslated: "Translated",
    turnStatusSpoken: "Spoken",
    ...
    noConversationYet: "No documented turns yet. Start the conversation and speak naturally.",
    noSpeechDetected: "No clear speech was detected. Please try again.",
    noTranscriptResult: "No transcript could be created for this turn. Please speak again.",
    readyForNextSpeaker: "Ready for the next speaker.",
    readyForEither: "Tone: patient or doctor/practice can begin now.",
    readyForDoctor: "Tone: doctor or practice team speaks now.",
    readyForPatient: "Tone: patient speaks now.",
  },
  ...
  sessionActions: {
    ...
    endPreparing: "Ending …",
    endHint: "The conversation has been marked as completed on this device.",
    ...
    export: "Download PDF",
    exportHint: "Download the conversation documentation as a PDF to this device.",
  ...
  realtimePage: {
    title: "Meda Live Interpreter",
    subtitle: "Live translation between patient and practice",
    timerAria: "Remaining session time: {{time}}",
    warningEnding:
      "The session ends in {{time}} — please finish or continue the conversation.",
    expiredBanner:
      "Session ended. For a new session, click “Start live conversation”.",
    status: {
      ended: "Session ended",
      ...
      speakingDetected: "Someone is speaking …",
      processing: "Processing …",
      translating: "Meda is translating …",
      speakingOutput: "Meda is speaking",
    },
    setup: {
      aria: "Set up live conversation",
      languagesTitle: "Languages",
      patientSpeaks: "Patient speaks",
      practiceSpeaks: "Practice speaks",
      personTitle: "Person details",
      personGroupAria: "Who is this conversation for?",
      forSelf: "This conversation is about me",
      forOther: "This conversation is about another person",
      ...
      relationLabel: "Relation to the person",
      relationPlaceholder: "e.g. mother, father, child, family member",
      practiceShow: "Add practice / doctor details",
      practiceHide: "Hide practice / doctor details",
      practiceHint: "Optional — helpful for the conversation log",
      practicePrefilled:
        "Practice details were copied from the practice profile and can be adjusted.",
      practiceNameLabel: "Practice / facility",
      practiceNamePlaceholder: "e.g. Family practice Miller",
      doctorNameLabel: "Doctor / clinician",
      doctorNamePlaceholder: "e.g. Dr. Anna Miller",
      specialtyLabel: "Specialty",
      specialtyPlaceholder: "e.g. General medicine, orthopedics",
      practiceEmailLabel: "Practice email",
      practiceEmailPlaceholder: "practice@example.com",
      practicePhoneLabel: "Practice phone",
      practiceStreetLabel: "Street and house number",
      practiceStreetPlaceholder: "e.g. Sample Street 1",
      practicePostalCodeLabel: "Postal code",
      practicePostalCodePlaceholder: "e.g. 10115",
      practiceCityLabel: "City",
      practiceCityPlaceholder: "e.g. Berlin",
      consentsAria: "Consents",
      consentAudio:
        "I confirm that audio and recognized text are processed for live translation.",
      consentContext:
        "I confirm that Meda is used only in a medical patient-care-team conversation.",
      consentMedical:
        "I understand that Meda only interprets and does not provide diagnosis, treatment recommendations, or urgency assessment.",
      consentPatient:
        "The patient has been informed about the automated live translation and agrees to the processing during this session.",
      localAudioNote:
        "Audio is not stored. In this version, the conversation log is not saved to the cloud automatically. PDF and archive are created locally on this device.",
      localSessionNote:
        "In this version, this information is used locally only for the current session and PDF export. Nothing is stored.",
      start: "Start live conversation",
      connecting: "Connecting …",
      blockLanguages: "Please choose two different languages.",
      blockName: "Please enter the person’s full name.",
      blockConsents: "Please confirm all consents.",
    },
    sessionBar: {
      patientLabel: "Patient",
      practiceLabel: "Practice",
      pauseAria: "Pause conversation",
      pauseTitle: "Pause conversation",
      resumeAria: "Resume conversation",
      resumeTitle: "Resume conversation",
      pauseButton: "Pause",
      resumeButton: "Resume",
      endButton: "End conversation",
    },
    mode: {
      groupAria: "Speaker detection mode",
      autoLabel: "Automatic",
      autoTitle: "Meda detects the language automatically",
      manualLabel: "Manual",
      manualTitle: "You choose who is speaking now",
      activeSpeakerAria: "Active speaker",
      activePatient: "Patient is speaking",
      activePractice: "Practice is speaking",
      detectedSpeakerAria: "Last detected speaker",
    },
    conversation: {
      aria: "Conversation history",
      emptyManualPatient: "Patient is active — please speak.",
      emptyManualPractice: "Practice is active — please speak.",
      emptyAuto: "Please speak — Meda detects the language automatically.",
      emptyIdle: "Start a conversation — the conversation history appears here.",
      rolePatient: "Patient",
      rolePractice: "Practice / doctor",
      roleUnknownLanguage: "Language not clearly identified",
      roleDetecting: "Detecting language …",
      // Kept segment without evidence for either side ("Paracetamol 500", a
      // name, a number) — never attributed on a guess.
      roleUncertain: "Speaker not reliably assigned",
      languageUncertain: "One of the session languages",
      sourceLanguageLabel: "Original language",
      unknownLanguage: "Unknown language",
      detectingLanguage: "Detecting language …",
      editOriginalAria: "Edit original text",
      editOriginalTitle:
        "Edit original text (Ctrl+Enter to save, Esc to cancel)",
      save: "Save",
      cancel: "Cancel",
      unsupportedLanguage:
        "Language outside the selected conversation languages.",
      editedBadge: "Original text corrected manually",
      translatorLabel: "Meda",
      translationForPatient: "Translation for patient",
      translationForPractice: "Translation for practice",
      translationGeneric: "Translation",
      speakTranslationAria: "Read translation aloud",
      speakTranslationTitle: "Read translation aloud",
      pendingTranscription: "Transcribing …",
      pendingTranslation: "Translating …",
    },
    endBox: {
      title: "Conversation log ready",
      hint:
        "You can download the PDF now or use the local history on this device.",
      hintEmpty: "No conversation history recorded.",
      continueTitle: "Continue conversation",
      continueHint:
        "The conversation history so far stays available. Only the live connection is rebuilt.",
      continueButton: "Continue conversation",
      continuing: "Reconnecting …",
      reasonManual: "Conversation ended.",
      reasonTimeLimit: "The planned conversation time has ended.",
      reasonInactivity: "The conversation was paused due to inactivity.",
      reasonConnection: "The live connection was interrupted.",
      ...
      savedLocally: "This log was saved locally on this device.",
      newSession: "Start new conversation",
      ariaDownloadPdf: "Download conversation log as PDF",
    },
    history: {
      title: "Local history",
      privacy:
      ...
      turnsCount: "{{count}} documented entries",
      pdf: "PDF",
      pdfLoadingShort: "PDF …",
      viewDetails: "View history",
      closeDetails: "Close",
      deleteEntry: "Delete",
      deleteAll: "Delete all local histories",
      ariaArchivePdf: "Download PDF for \"{{label}}\"",
      ariaDelete: "Delete history entry \"{{label}}\"",
      noStoredTurns: "No conversation history stored.",
      unclear: "Not assigned with certainty",
      originalLabel: "Original",
      translationForPatient: "Translation for patient",
      translationForPractice: "Translation for practice",
      editedBadge: "Original text corrected manually",
    ...
    confirm: {
      deleteEntry: "Really delete this local conversation log?",
      deleteAll: "Really delete all local conversation logs?",
    },
  },
