...
export default {
  ...
  hubCard: {
    ...
    description: "Secure communication for international patients",
    badge: "Communication",
    ariaLabel: "Open multilingual communication for this practice",
  },
  hub: {
    pageTitle: "Multilingual communication — Practice",
    heading: "Multilingual communication",
    intro:
  ...
  invites: {
    pageTitle: "Invitation links — Multilingual communication",
    heading: "Patient invitation links",
    intro:
      "Create a secure link or QR code so patients can start the interpreter in your practice. Conversation text is shared only after explicit patient consent.",
    navAria: "Invitation links navigation",
    backToDashboard: "Back to dashboard",
    actionsHeading: "New invitation",
    requiredLegend: "Fields marked * are required",
    inviteTypeLabel: "Location *",
    inviteTypeHint: "Helps you identify links later.",
    inviteTypeWaitingRoom: "Waiting area",
    inviteTypeReception: "Reception",
    inviteTypeDoctorRoom: "Consultation room",
    inviteTypeRemote: "Video / remote",
    inviteTypeOther: "General",
    inviteTypeRequired: "Please select a location.",
    inviteTypeSelectEmpty: "Please select",
    displayNameLabel: "Label (optional)",
    displayNameHint: "e.g. “Reception ground floor” — for your overview only.",
    displayNamePlaceholder: "Internal label",
    ttlHoursLabel: "Validity in hours (optional)",
    ttlHoursHint: "Default: 168 hours (7 days). Maximum 720 hours.",
    placeholderNote:
      "Patients open the link on their phone and choose their languages. They keep control of conversation content.",
    copyLink: "Copy link",
