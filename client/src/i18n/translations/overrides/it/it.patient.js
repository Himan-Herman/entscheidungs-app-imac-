...
export default {
  patientCardInfo: {
    ...
    medaLiveButton: "Maggiori informazioni su Meda Live Translation",
    medaLiveTitle: "Meda Live Translation",
    medaLiveP1:
      "Meda Live Translation supporta le conversazioni multilingue durante una visita medica tramite microfono, trascrizione e visualizzazione della traduzione.",
    medaLiveP2:
      "Questa funzione serve solo a sostenere la comunicazione. MedScoutX non ricava dal parlato alcuna diagnosi, raccomandazione terapeutica o valutazione dell’urgenza. Il microfono si attiva solo dopo una tua azione consapevole.",
    medaLiveP3:
      "Nel test alpha puoi verificare: la sessione si avvia in modo chiaro, trascrizione e traduzione sono comprensibili, e la scelta delle lingue, l’audio e i comandi della sessione sono affidabili?",
  ...
  roleEntry: {
    ...
    hubLinkMyPractice: "I miei studi",
  ...
  practiceContext: {
    yourDataHeading: "I suoi dati presso questo studio",
    backToHub: "Torna alla panoramica di questo studio",
    dataControlTitle: "I miei dati e permessi",
    dataControlHint: "Che cosa può vedere questo studio – e le sue richieste",
    activityTitle: "La mia attività",
    activityHint: "Che cosa è successo tra lei e questo studio",
     dictate: "Detta",
     dictationRecording: "Registrazione in corso",
     dictationStop: "Interrompi la registrazione",
     dictationProcessing: "Riconoscimento vocale …",
     dictationHint: "Controlla il testo riconosciuto prima di inviarlo.",
     dictationFailed: "Non è stato possibile elaborare la registrazione.",
     dictationUnavailable: "La dettatura al momento non è disponibile.",
     dictationTooLong: "La registrazione è troppo lunga.",
     micDenied: "L'accesso al microfono non è stato consentito.",
     micUnavailable: "Nessun microfono trovato.",
     speak: "Leggi ad alta voce",
     speakStop: "Interrompi la lettura",
     speakOriginal: "Leggi l'originale ad alta voce",
     speakTranslation: "Leggi la traduzione ad alta voce",
     speakSimple: "Leggi la formulazione semplificata ad alta voce",
     speaking: "Lettura in corso",

     showSimple: "Mostra con parole più semplici",
     simple: "Formulazione semplificata",
     simpleLabel: "Testo semplificato",
     simpleNote: "Formulazione semplificata. Fa fede il testo originale.",
     simplifying: "Riformulazione in corso …",
     simpleUnsafe: "Non è stato possibile creare una formulazione più semplice in modo sicuro.",
     simpleFailed: "Non è stato possibile creare la formulazione semplificata.",
     renderingLabel: "Rappresentazione",
     ...
     translationFailed: "La traduzione non è riuscita.",
     translationUnavailable: "La traduzione al momento non è disponibile.",
     retry: "Riprova",
     targetLanguage: "Lingua di destinazione",
     translationNote: "Traduzione automatica. Fa fede il testo originale.",
     originalLabel: "Testo originale",
     translationLabel: "Testo tradotto",

     messageActions: "Opzioni del messaggio",
     edit: "Modifica",
     withdraw: "Ritira",
     editSave: "Salva le modifiche",
     editCancel: "Annulla la modifica",
     editLabel: "Modifica messaggio",
     edited: "Modificato",
     withdrawnOwn: "Hai ritirato questo messaggio.",
     withdrawnOther: "Questo messaggio è stato ritirato.",
     withdrawTitle: "Ritirare il messaggio?",
     withdrawBody: "Il testo viene rimosso dalla conversazione e non può essere ripristinato. Lo studio vedrà soltanto che un messaggio è stato ritirato.",
     withdrawConfirm: "Ritira",
     withdrawCancel: "Annulla",
     errorAlreadyRead: "Il messaggio è stato letto nel frattempo e non può più essere modificato.",
     errorWithdrawn: "Questo messaggio è già stato ritirato.",
     errorEditFailed: "Non è stato possibile salvare la modifica.",
     errorEmpty: "Inserisci un testo oppure ritira il messaggio.",

     loadOlder: "Carica messaggi precedenti",
     loadingOlder: "Caricamento …",
     noOlder: "Nessun messaggio precedente.",
     statusSent: "Inviato",
     statusRead: "Letto",
     statusAriaSent: "Stato: inviato",
     statusAriaRead: "Stato: letto dallo studio",

     telemedicineTitle: "Videoconsulto",
     telemedicineHint: "Appuntamenti video di questo studio",
     telemedicineEmpty: "Non ci sono videoconsulti programmati con questo studio.",
     telemedicineScopeNote: "Qui compaiono solo i videoconsulti di questo rapporto di cura.",

     inboxRestore: "Ripristina",

     inboxTitle: "Posta",
     inboxHint: "Comunicazioni di questo studio",
     inboxEmpty: "Nessuna nuova informazione da questo studio.",
     inboxScopeNote: "Qui compaiono solo le comunicazioni di questo rapporto di cura.",

     erezeptTitle: "Ricette",
     erezeptHint: "Ricette di questo studio",
     erezeptEmpty: "Questo studio non ti ha ancora rilasciato ricette.",
     erezeptScopeNote: "Qui compaiono solo le ricette di questo studio.",

     contextOwnAccount: "Il mio account",
     contextForProfile: "Per {name}",

     medicationTitle: "Piano terapeutico",
     medicationHint: "Piani di questo studio",
     medicationEmpty: "Questo studio non ti ha ancora trasmesso un piano terapeutico.",
     medicationScopeNote: "Qui compaiono solo i piani terapeutici di questo studio. I farmaci che inserisci tu restano separati.",
     medicationOrderNote: "Prima la pubblicazione più recente. I piani precedenti restano leggibili e non vengono sostituiti automaticamente.",
     medicationOwnLink: "Ai miei farmaci",

     documentsTitle: "Documenti",
     documentsHint: "Documenti di questo studio",
     documentsOriginDirect: "Da questo studio",
     documentsOriginShared: "Condiviso da te",
     documentsOriginSharedFrom: "Condiviso da te – originariamente da {practice}",
     documentsEmpty: "Non ci sono ancora documenti per questo studio.",
     documentsScopeNote: "Qui compaiono solo i documenti di questo studio e quelli che gli hai condiviso.",

    appointmentsTitle: "Appuntamenti",
    appointmentsHint: "Appuntamenti con questo studio",
    crossPracticeLink: "Funzioni tra studi",
    chooserTitle: "I miei studi",
    chooserIntro: "Scegli uno studio per vedere i suoi messaggi e documenti.",
    searchLabel: "Cerca studio",
    searchPlaceholder: "Nome, specialità o città",
    searchNoResults: "Nessuno dei tuoi studi corrisponde a questa ricerca.",
    formerTitle: "Studi precedenti",
    formerHint: "Il collegamento è terminato. Puoi ancora leggere la conversazione.",
    emptyTitle: "Nessuno studio collegato",
    emptyBody: "Non appena uno studio ti collega, apparirà qui.",
    statusFormer: "Collegamento terminato",
    statusConsentPending: "Autorizzazioni in sospeso",
    consentPendingTitle: "Ancora nessuna condivisione",
    consentPendingBody: "{practice} potrà inviarle messaggi e documenti solo dopo che avrà deciso che cosa lo studio può vedere.",
    consentPendingAction: "Scegli le autorizzazioni",
    backToChooser: "Torna a «I miei studi»",
    unreadShort: "nuovi",
    ...
    switchAction: "Cambia studio",
    switchTitle: "Cambia studio",
    switchCurrent: "Attualmente aperto",
    switchAria: "Cambia studio. Attualmente: {practice}",
    messagesEmpty: "Nessun messaggio con questo studio.",
    messagesLabel: "Cronologia dei messaggi",
    senderYou: "Tu",
    senderPractice: "Studio",
    replyLabel: "Scrivi una risposta",
    send: "Invia",
    sending: "Invio …",
    sendError: "Impossibile inviare il messaggio.",
    sendForbidden: "Non c'è consenso per i messaggi con questo studio.",
    loading: "Caricamento dell'area dello studio …",
    notFoundTitle: "Area non disponibile",
    notFoundBody:
      "Quest'area dello studio non è collegata al tuo account. Scegli uno studio dalla tua panoramica.",
    errorTitle: "Impossibile caricare quest'area",
    errorBody: "Riprova.",
    backToOverview: "Torna alla panoramica degli studi",
    relationshipEnded: "Questo collegamento è terminato. Puoi ancora leggere la conversazione.",
  },
  patientThreads: {
  ...
  patientPracticeDocuments: {
    translation: {
      heading: "Traduci o semplifica questo documento",
      subtitle:
        "Scegli una lingua e una presentazione. Il documento originale resta invariato.",
      sourceLanguageNote: "Attualmente previsto per documenti dello studio in lingua tedesca.",

      fileLabel: "File del documento",
      filePlaceholder: "Seleziona un file",

      modeLegend: "Presentazione",
      modeStrictName: "Traduzione specialistica",
      modeStrictDescription:
        "La terminologia medica e il livello di dettaglio vengono mantenuti.",
      modePlainName: "Linguaggio semplice",
      modePlainDescription:
        "Stesso contenuto, chiaro e senza tecnicismi inutili.",

      targetLanguageLabel: "Lingua di destinazione",
      targetLanguagePlaceholder: "Seleziona una lingua",

      hintSameLanguageStrict:
        "Per una traduzione specialistica scegli un\u2019altra lingua. Se vuoi leggere il documento in tedesco in modo più comprensibile, scegli «Linguaggio semplice».",
      ...
      pdfExportFailed:
        "Non è stato possibile creare il PDF. Riprova. Il documento originale resta disponibile e invariato.",
  ...
  patientPracticeLinks: {
    ...
    acceptScopesHint:
      "Selezioni ciò che lo studio può vedere. Nulla è preselezionato e può revocare un'autorizzazione in qualsiasi momento.",
    acceptButton: "Concedi l'autorizzazione",
    requestScopesLegend: "Che cosa può vedere {practice}?",
    openPractice: "Vai allo studio",
  ...
  patientDataControl: {
    ...
    requestedOn: "Inviata il {date}",
    requestsScopedEmpty: "Non ha ancora inviato richieste a questo studio.",
    requestsScopedIntro: "Esportazione o cancellazione dei dati: qui vede lo stato della sua richiesta e la risposta dello studio.",
    requestsScopedTitle: "Le sue richieste a questo studio",
    profileScopedOff: "Il suo profilo non è condiviso con questo studio.",
    profileScopedOn: "Questo studio può vedere il suo profilo.",
    profileScopedTitle: "Il suo profilo",
    introScoped: "Che cosa può vedere questo studio, che cosa ha richiesto e che cosa ha risposto lo studio.",
    ...
    consentSummaryManage: "Visualizza o modifica i permessi",
    ...
    archiveLink: "Archivia il collegamento",
    ...
    requestSuccess: "La sua richiesta è stata inviata allo studio.",
    requestExportSuccess: "La sua richiesta di esportazione è stata inviata allo studio.",
    ...
    exportConfirmBody2:
      "Lo studio esaminerà la sua richiesta. Lo stato e la risposta dello studio sono visibili in «I miei dati e permessi». Può richiedere un po’ di tempo.",
  ...
  patientActivity: {
    ...
    introScoped: "Che cosa è successo tra lei e questo studio – senza contenuti medici.",
    type_fallback: "Evento",
    type_thread_restored: "Conversazione ripristinata",
    type_consent_expired: "Permesso scaduto",
    type_consent_revoked: "Permesso revocato",
    type_consent_granted: "Permesso concesso",
    ...
    type_document_downloaded: "Documento scaricato",
    ...
    type_medication_plan_published: "Piano terapeutico messo a disposizione",
    type_medication_plan_opened: "Piano terapeutico aperto",
    type_relationship_archived: "Collegamento archiviato",
    type_relationship_status_changed: "Collegamento modificato",
    type_data_request_submitted: "Richiesta dati inviata",
    type_data_export_requested: "Esportazione richiesta",
    type_data_request_updated: "Richiesta sui dati: stato modificato",
    type_thread_created: "Conversazione avviata",
  ...
  patientChatHistory: {
    ...
    deleteConversation: "Rimuovi dalla cronologia",
    deleteConversationAria: "Rimuovi dalla cronologia: {{title}}",
    deleteConfirmTitle: "Rimuovere la conversazione dalla cronologia?",
    deleteConfirmBody:
      "La conversazione verrà rimossa dalla cronologia su questo dispositivo.",
    deleteConfirmAction: "Rimuovi",
    deleteCancel: "Annulla",
