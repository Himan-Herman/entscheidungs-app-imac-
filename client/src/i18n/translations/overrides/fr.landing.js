export default {
  pageTitle: "MedScoutX — Mieux préparer la communication médicale",
  ...
  login: "Connexion",
  trustLine:
    "Aucun diagnostic. Aucune recommandation thérapeutique. Ne remplace pas les soins médicaux. MedScoutX soutient la communication, l’orientation et la continuité dans le parcours de soins.",
  metricsAria: "Principaux domaines de MedScoutX",
  metricA: "Continuité du parcours",
  metricB: "Communication multilingue",
  metricC: "Transitions claires entre les rôles",
  ...
  mediaSignalOne: "Saisir clairement les informations du patient",
  mediaSignalTwo: "Réduire les obstacles linguistiques avec précision",
  mediaSignalThree: "Design calme et sensible à la confidentialité",
  visualAria:
    "Illustration du flux d’information entre patient, MedScoutX et cabinet",
  visualPatient: "Patient",
  visualPractice: "Cabinet",
  visualBridge: "MedScoutX",
  visualChipSymptoms: "Symptômes",
  visualChipDocuments: "Documents",
  visualChipMessages: "Messages",
  visualChipLanguage: "DE -> FR",
  visualStatusPrepared: "Préparation structurée",
  visualStatusLinked: "Le cabinet voit l’essentiel d’abord",
  ...
  domainFourItems: [
    ...
    "Sécurité, intégrations et billing plausibility",
  ],
