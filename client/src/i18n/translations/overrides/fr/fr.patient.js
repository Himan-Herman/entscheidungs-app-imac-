...
export default {
  ...
  roleEntry: {
    ...
    hubLinkMyPractice: "Mes cabinets",
  ...
  practiceContext: {
    yourDataHeading: "Vos données auprès de ce cabinet",
    backToHub: "Retour à l’aperçu de ce cabinet",
    dataControlTitle: "Mes données et partages",
    dataControlHint: "Ce que ce cabinet peut voir – et vos demandes",
    activityTitle: "Mon activité",
    activityHint: "Ce qui s’est passé entre vous et ce cabinet",
     dictate: "Dicter",
     dictationRecording: "Enregistrement en cours",
     dictationStop: "Arrêter l'enregistrement",
     dictationProcessing: "Reconnaissance vocale …",
     dictationHint: "Veuillez vérifier le texte reconnu avant de l'envoyer.",
     dictationFailed: "L'enregistrement n'a pas pu être traité.",
     dictationUnavailable: "La dictée n'est pas disponible actuellement.",
     dictationTooLong: "L'enregistrement est trop long.",
     micDenied: "L'accès au microphone n'a pas été autorisé.",
     micUnavailable: "Aucun microphone n'a été trouvé.",
     speak: "Lire à voix haute",
     speakStop: "Arrêter la lecture",
     speakOriginal: "Lire l'original à voix haute",
     speakTranslation: "Lire la traduction à voix haute",
     speakSimple: "Lire la formulation simplifiée à voix haute",
     speaking: "Lecture en cours",

     showSimple: "Afficher en mots plus simples",
     simple: "Formulation simplifiée",
     simpleLabel: "Texte simplifié",
     simpleNote: "Formulation simplifiée. Le texte original fait foi.",
     simplifying: "Reformulation en cours …",
     simpleUnsafe: "Une formulation plus simple n'a pas pu être produite en toute sécurité.",
     simpleFailed: "La formulation simplifiée n'a pas pu être créée.",
     renderingLabel: "Présentation",
     ...
     translationUnavailable: "La traduction n'est pas disponible actuellement.",
     retry: "Réessayer",
     targetLanguage: "Langue cible",
     translationNote: "Traduction automatique. Le texte original fait foi.",
     originalLabel: "Texte original",
     translationLabel: "Texte traduit",
     ...
     edited: "Modifié",
     withdrawnOwn: "Vous avez retiré ce message.",
     withdrawnOther: "Ce message a été retiré.",
     withdrawTitle: "Retirer le message ?",
     withdrawBody: "Le texte est retiré de la conversation et ne peut pas être restauré. Le cabinet verra uniquement qu'un message a été retiré.",
     withdrawConfirm: "Retirer",
     withdrawCancel: "Annuler",
     errorAlreadyRead: "Le message a entre-temps été lu et ne peut plus être modifié.",
     errorWithdrawn: "Ce message a déjà été retiré.",
     errorEditFailed: "La modification n'a pas pu être enregistrée.",
     errorEmpty: "Veuillez saisir un texte ou retirer le message.",

     loadOlder: "Charger les messages plus anciens",
     loadingOlder: "Chargement …",
     noOlder: "Aucun message plus ancien.",
     statusSent: "Envoyé",
     statusRead: "Lu",
     statusAriaSent: "Statut : envoyé",
     statusAriaRead: "Statut : lu par le cabinet",

     telemedicineTitle: "Téléconsultation",
     telemedicineHint: "Rendez-vous vidéo de ce cabinet",
     telemedicineEmpty: "Aucune téléconsultation n'est prévue avec ce cabinet.",
     telemedicineScopeNote: "Seules les téléconsultations de cette relation de soins apparaissent ici.",

     inboxRestore: "Restaurer",

     inboxTitle: "Boîte de réception",
     inboxHint: "Avis de ce cabinet",
     inboxEmpty: "Aucune nouvelle information de ce cabinet.",
     inboxScopeNote: "Seuls les avis de cette relation de soins apparaissent ici.",

     erezeptTitle: "Ordonnances",
     erezeptHint: "Ordonnances de ce cabinet",
     erezeptEmpty: "Ce cabinet ne vous a encore délivré aucune ordonnance.",
     erezeptScopeNote: "Seules les ordonnances de ce cabinet apparaissent ici.",

     contextOwnAccount: "Mon propre compte",
     contextForProfile: "Pour {name}",

     medicationTitle: "Plan de médication",
     medicationHint: "Plans de ce cabinet",
     medicationEmpty: "Ce cabinet ne vous a pas encore transmis de plan de médication.",
     medicationScopeNote: "Seuls les plans de médication de ce cabinet apparaissent ici. Les médicaments que vous saisissez vous-même restent séparés.",
     medicationOrderNote: "Publication la plus récente en premier. Les plans plus anciens restent lisibles et ne sont pas remplacés automatiquement.",
     medicationOwnLink: "Vers mes propres médicaments",

     documentsTitle: "Documents",
     documentsHint: "Documents de ce cabinet",
     documentsOriginDirect: "De ce cabinet",
     documentsOriginShared: "Partagé par vous",
     documentsOriginSharedFrom: "Partagé par vous – à l'origine de {practice}",
     documentsEmpty: "Aucun document pour ce cabinet pour le moment.",
     documentsScopeNote: "Seuls les documents de ce cabinet et ceux que vous lui avez partagés apparaissent ici.",

    appointmentsTitle: "Rendez-vous",
    appointmentsHint: "Rendez-vous avec ce cabinet",
    crossPracticeLink: "Fonctions inter-cabinets",
    chooserTitle: "Mes cabinets",
    chooserIntro: "Choisissez un cabinet pour voir ses messages et documents.",
    searchLabel: "Rechercher un cabinet",
    searchPlaceholder: "Nom, spécialité ou ville",
    searchNoResults: "Aucun de vos cabinets ne correspond à cette recherche.",
    formerTitle: "Anciens cabinets",
    formerHint: "La connexion est terminée. Vous pouvez encore lire l'historique.",
    emptyTitle: "Aucun cabinet connecté",
    emptyBody: "Dès qu'un cabinet vous connecte, il apparaît ici.",
    statusFormer: "Connexion terminée",
    statusConsentPending: "Autorisations en attente",
    consentPendingTitle: "Rien de partagé pour l'instant",
    consentPendingBody: "{practice} ne pourra vous envoyer des messages et des documents qu'une fois que vous aurez choisi ce que le cabinet peut voir.",
    consentPendingAction: "Choisir les autorisations",
    backToChooser: "Retour à « Mes cabinets »",
    unreadShort: "nouv.",
    ...
    switchAction: "Changer de cabinet",
    switchTitle: "Changer de cabinet",
    switchCurrent: "Actuellement ouvert",
    switchAria: "Changer de cabinet. Actuellement : {practice}",
    messagesEmpty: "Aucun message avec ce cabinet pour le moment.",
    messagesLabel: "Historique des messages",
    senderYou: "Vous",
    senderPractice: "Cabinet",
    replyLabel: "Écrire une réponse",
    send: "Envoyer",
    sending: "Envoi …",
    sendError: "Le message n'a pas pu être envoyé.",
    sendForbidden: "Aucun consentement pour les messages avec ce cabinet.",
    loading: "Chargement de l'espace du cabinet …",
    notFoundTitle: "Espace indisponible",
    notFoundBody:
      "Cet espace de cabinet n'est pas lié à votre compte. Veuillez choisir un cabinet dans votre aperçu.",
    errorTitle: "Impossible de charger cet espace",
    errorBody: "Veuillez réessayer.",
    backToOverview: "Retour à l'aperçu des cabinets",
    relationshipEnded: "Cette connexion est terminée. Vous pouvez encore lire l'historique.",
  },
  patientThreads: {
  ...
  patientPracticeDocuments: {
    translation: {
      heading: "Traduire ou simplifier ce document",
      subtitle:
        "Choisissez une langue et une présentation. Le document original reste inchangé.",
      ...
      modeLegend: "Présentation",
      modeStrictName: "Traduction spécialisée",
      modeStrictDescription:
        "La terminologie médicale et le niveau de détail sont conservés.",
      modePlainName: "Langage clair",
      modePlainDescription:
        "Même contenu — clair, sans jargon inutile.",

      targetLanguageLabel: "Langue cible",
      targetLanguagePlaceholder: "Choisir une langue",

      hintSameLanguageStrict:
        "Pour une traduction spécialisée, veuillez choisir une autre langue. Pour lire le document plus facilement en allemand, choisissez « Langage clair ».",
      ...
      pdfExportFailed:
        "Le PDF n'a pas pu être créé. Veuillez réessayer. Le document original reste disponible et inchangé.",
  ...
  patientPracticeLinks: {
    ...
    acceptScopesHint:
      "Cochez ce que le cabinet peut voir. Rien n'est présélectionné, et vous pouvez retirer une autorisation à tout moment.",
    acceptButton: "Accorder l'autorisation",
    requestScopesLegend: "Que peut voir {practice} ?",
    openPractice: "Aller au cabinet",
  ...
  patientDataControl: {
    ...
    requestedOn: "Envoyée le {date}",
    requestsScopedEmpty: "Vous n’avez encore adressé aucune demande à ce cabinet.",
    requestsScopedIntro: "Export ou suppression de données : suivez l’état de votre demande et la réponse du cabinet.",
    requestsScopedTitle: "Vos demandes à ce cabinet",
    profileScopedOff: "Votre profil n’est pas partagé avec ce cabinet.",
    profileScopedOn: "Ce cabinet peut voir votre profil.",
    profileScopedTitle: "Votre profil",
    introScoped: "Ce que ce cabinet peut voir, ce que vous avez demandé et ce que le cabinet a répondu.",
    ...
    consentSummaryManage: "Voir ou modifier les partages",
    ...
    requestSuccess: "Votre demande a été envoyée au cabinet.",
    requestExportSuccess: "Votre demande d’export a été envoyée au cabinet.",
    ...
    exportConfirmBody2:
      "Le cabinet examinera votre demande. Vous pouvez suivre son état et la réponse du cabinet dans « Mes données et partages ». Cela peut prendre un certain temps.",
  ...
  patientActivity: {
    ...
    introScoped: "Ce qui s’est passé entre vous et ce cabinet – sans contenu médical.",
    type_fallback: "Événement",
    type_thread_restored: "Conversation restaurée",
    type_consent_expired: "Partage expiré",
    type_consent_revoked: "Partage retiré",
    type_consent_granted: "Partage accordé",
    ...
    type_document_downloaded: "Document téléchargé",
    ...
    type_medication_plan_published: "Plan de médication mis à disposition",
    type_medication_plan_opened: "Plan de médication ouvert",
    type_relationship_archived: "Lien archivé",
    type_relationship_status_changed: "Lien modifié",
    type_data_request_submitted: "Demande de données envoyée",
    type_data_export_requested: "Export demandé",
    type_data_request_updated: "Demande de données : statut modifié",
    type_thread_created: "Conversation commencée",
    type_thread_closed: "Conversation close",
    type_thread_archived: "Conversation archivée",
  },
  ...
  patientChatHistory: {
    ...
    deleteConversation: "Retirer de l’historique",
    deleteConversationAria: "Retirer de l’historique : {{title}}",
    deleteConfirmTitle: "Retirer la conversation de l’historique ?",
    deleteConfirmBody:
      "La conversation sera retirée de l’historique sur cet appareil.",
    deleteConfirmAction: "Retirer",
    deleteCancel: "Annuler",
