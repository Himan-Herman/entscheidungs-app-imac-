...
const itPublicDemo = {
  publicDemo: {
    ...
    notice: {
      badge: "DemoDay / Fiera",
      title: "Benvenuto in MedScoutX",
      body: "Per la fiera e il DemoDay è disponibile una demo pubblica con dati di esempio. Puoi esplorare MedScoutX senza un account, con dati di esempio, e conoscere le aree principali.",
      body2: "Gli utenti esistenti possono continuare ad accedere come di consueto. La demo contiene esclusivamente dati di esempio e non mostra dati reali dei pazienti.",
      primary: "Guarda la demo della fiera",
      secondary: "Accedi",
      dismiss: "Continua alla home",
    },
