...
export const ruPracticePatients = {
  practicePatients: {
    dataRequestSaveError: "Не удалось сохранить. Попробуйте ещё раз.",
    dataRequestAlreadyAnswered: "На этот запрос уже дан ответ.",
    dataRequestForbidden: "Ваша роль не позволяет выполнить это действие.",
    dataRequestAnswerRequired: "Сначала напишите ответ пациенту.",
    dataRequestPartialHint: "Если вы не удовлетворяете запрос или удовлетворяете его частично, укажите причины. Пациент дополнительно увидит сведения о возможности подать жалобу или обратиться в суд.",
    dataRequestAnswerRoleInfo: "Ответ пациенту составляет уполномоченная роль практики — например, врач или руководство.",
    dataRequestAnswered: "Ответ отправлен. Запрос отмечен как «Ответ отправлен».",
    dataRequestSendAnswer: "Отправить ответ и отметить «Ответ отправлен»",
    dataRequestMarkedInReview: "Отмечено «В работе».",
    dataRequestMarkInReview: "Отметить «В работе»",
    dataConsentAnsweredOn: "Ответ отправлен {date}",
    dataConsentReceivedOn: "Получен {date}",
    dataConsentVisibleToPatient: "видно пациенту",
    dataConsentReadOnly: "Только просмотр",
    tabDataConsent: "Данные и разрешения",
    dataConsentConsentsTitle: "Разрешения пациента",
    dataConsentConsentsIntro: "Только пациент может выдавать и отзывать разрешения. Здесь показано текущее состояние, от которого зависит ваш доступ.",
    dataConsentConsentsNone: "Сейчас разрешений нет.",
    dataConsentGrantedSince: "выдано {date}",
    dataConsentExpires: "действует до {date}",
    dataConsentRequestsTitle: "Запросы по данным",
    dataConsentRequestsIntro: "Статус и ваш ответ видны пациенту в MedScoutX.",
    dataConsentRequestsNone: "Запросов нет.",
    dataConsentPatientReason: "Комментарий пациента",
    dataConsentResponseSent: "Ваш ответ",
    dataConsentResponseLabel: "Ответ пациенту",
    dataConsentResponseHint: "Этот ответ виден пациенту.",
    dataConsentSaving: "Сохранение …",
    dataConsentLoadError: "Не удалось загрузить данные и разрешения.",
    dataConsentOpenAll: "Все запросы практики",
