...
export const ruPracticePatients = {
  practicePatients: {
    ...
    dataConsentConsentsIntro: "Только пациент может выдавать и отзывать разрешения. Здесь показано текущее состояние, по которому проверяется ваш доступ.",
    ...
    dataConsentRequestsIntro: "Запросы этого пациента к вашей практике. Статус и ваш ответ видны пациенту.",
    dataConsentRequestsNone: "Запросов от этого пациента нет.",
    dataConsentPatientReason: "Комментарий пациента",
    dataConsentResponseSent: "Ваш ответ (виден пациенту)",
    dataConsentStatusLabel: "Новый статус",
    dataConsentResponseLabel: "Ответ пациенту",
    dataConsentResponseHint: "Будет показан пациенту. Не пишите здесь внутренние заметки — для них есть «Внутренние заметки».",
    dataConsentSave: "Сохранить статус и ответ",
    dataConsentSaving: "Сохранение …",
    dataConsentSaved: "Сохранено. Статус и ответ теперь видны пациенту в разделе этой практики.",
    dataConsentSaveError: "Не удалось сохранить. Попробуйте ещё раз.",
    dataConsentForbidden: "Ваша роль не позволяет обрабатывать запросы по данным.",
    dataConsentDeletionManual: "Запрос на удаление можно отметить как «Завершён» только после фактического удаления. Переведите его в статус «На рассмотрении» или отклоните с объяснением.",
