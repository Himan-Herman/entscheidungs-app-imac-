...
export const ruPracticePatients = {
  practicePatients: {
    ...
    dataConsentSaved: "Сохранено. Статус и ваш ответ теперь видны пациенту.",
    ...
    dataConsentDeletionManual: "Запросы на удаление здесь пока нельзя отметить как завершённые. Оставьте статус «В работе» и сообщите результат в ответе.",
