...
export default {
  hub: {
    ...
    subtitle: "Traducción en directo y apoyo a la comunicación",
    ...
    ariaLabel: "Abrir el módulo Intérprete médico",
  },

  chrome: {
    moduleTitle: "Intérprete médico",
