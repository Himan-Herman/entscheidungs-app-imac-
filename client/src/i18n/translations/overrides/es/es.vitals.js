export default {
  ...
  connect: {
    ...
    intro: "¿Lleva un reloj inteligente o usa un dispositivo de medición digital? Conéctelo para que sus mediciones aparezcan aquí automáticamente.",
    appHint: "La importación automática comienza en cuanto la aplicación MedScoutX esté instalada en su teléfono. Sin dispositivo, sigue introduciendo sus mediciones manualmente como hasta ahora: para usted no cambia nada.",
