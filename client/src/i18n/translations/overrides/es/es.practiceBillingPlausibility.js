...
export const esPracticeBillingPlausibility = {
  ...
  catalogueSubsetNote:
    "El catálogo GOÄ utilizado es un subconjunto de prueba local. Los códigos no encontrados aquí requieren verificación con el texto oficial GOÄ vigente.",
  dataProcessingNote:
    "Datos almacenados: códigos GOÄ, factores y notas de contexto opcionales únicamente. No se aceptan ni almacenan datos del paciente.",
  ...
  catalogueStatusVerified: "Verificado",
  catalogueStatusPointsUncertain: "Puntos no verificados",
  catalogueStatusNeedsReview: "Requiere revisión",
  catalogueStatusUnknown: "Estado del catálogo no especificado",
  catalogueSourceReference: "Referencia fuente",
...
export const esPracticeIntegrationsVendors = {
  enterprisePathwayNote:
    "Las integraciones PVS/FHIR/KIS están preparadas como vía empresarial. La activación requiere un piloto validado, un acuerdo de proveedor/API y una revisión del tratamiento de datos. Ningún conector está activo en producción por ahora.",

  sectionVendors: "Sistemas PVS disponibles",
  vendorCatalogueNote:
    "La activación requiere un acuerdo de proveedor/API, un sistema de prueba validado y una revisión técnica. Ninguno de estos conectores está disponible en producción por ahora.",
  vendorStatusComingSoon: "Próximamente",
  vendorStatusPilotRequired: "Piloto requerido",
