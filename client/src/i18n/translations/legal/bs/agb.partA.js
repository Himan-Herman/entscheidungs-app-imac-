    ...
    blocks: [
      {
        type: "html",
        html: `
<p>Ovi Uslovi korištenja uređuju korištenje mobilne i web aplikacije <strong>MedScoutX</strong> („Aplikacija”) od strane krajnjih privatnih korisnika.</p>
...
`.trim(),
  ...
  {
    id: "agb-3-vertrag",
    heading: "§3 Zahtjevi za korištenje, registracija i nalog",
    blocks: [
      {
        type: "html",
        html: `
<p>(1) Korištenje MedScoutX općenito zahtijeva korisnički nalog. Registracija je dozvoljena samo osobama koje su navršile <strong>18 godina</strong>.</p>
<p>(2) Pri registraciji korisnik izričito potvrđuje da ima najmanje 18 godina. Pružalac može zatražiti dokaz o godinama ili suspendirati naloge ako postoji razumna sumnja u dob.</p>
...
<li>upravljanje korisničkim nalogom i funkcije istorije,</li>
